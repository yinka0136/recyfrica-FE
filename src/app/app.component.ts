  ...
  ngOnInit(): void {
    ...
    this.metaService.addTags([
      ...
      },
      {
        name: 'keywords',
        content:
          'plastic pollution, waste management, zero waste, sustainability matters, climate change, environment , sustainability, circular economy, recycling, community, climate crisis, plastic recycling',
      },
